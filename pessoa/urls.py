...
from .views import ListaPessoaView, PessoaCreateView, PessoaUpdateView, PessoaDeletarView, contato_remover
from . import views
urlpatterns = [
    ...
    path('<int:pk>/remover', PessoaDeletarView.as_view(), name='pessoa.remover'),
